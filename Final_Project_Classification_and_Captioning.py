...
# Part 1 - Classification: classify aircraft defect as 'dent' or 'crack'

# Configuration: batch size = 32, epochs = 5
batch_size = 32
n_epochs = 5
...
#   directory=valid_dir, class_mode='binary', seed=seed_value,
...
#   directory=test_dir, class_mode='binary', seed=seed_value,
#   batch_size=batch_size, shuffle=False, target_size=(img_rows, img_cols)
...
#   train_data=train_generator, epochs=n_epochs, validation_data=valid_generator
history = model.fit(
    train_generator,
    epochs=n_epochs,
...
#   figsize=(5, 5); plot train_history['accuracy'] and ['val_accuracy'];
#   title='Accuracy Curve', xlabel='Epochs', ylabel='Accuracy'
...
#   test_data_generator=test_generator, model=model, index_to_plot=1
index_to_plot = 1
...
#   generate_text(image_path, task): create a BlipCaptionSummaryLayer instance,
#   call it with (image_path, task), return the result
...
example_caption = generate_text(example_image_path, tf.constant("caption"))
print("Caption:", example_caption.numpy().decode("utf-8"))

example_summary = generate_text(example_image_path, tf.constant("summary"))
print("Summary:", example_summary.numpy().decode("utf-8"))
...
caption_output = generate_text(image_path, tf.constant("caption"))
print("Caption:", caption_output.numpy().decode("utf-8"))

# Task 10: Generate a summary of an image using BLIP pretrained model
image_path = tf.constant("aircraft_damage_dataset_v1/test/dent/149_22_JPG_jpg.rf.4899cbb6f4aad9588fa3811bb886c34d.jpg")

summary_output = generate_text(image_path, tf.constant("summary"))
print("Summary:", summary_output.numpy().decode("utf-8"))
